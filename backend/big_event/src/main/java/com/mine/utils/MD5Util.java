...
public class MD5Util {
     ...
     */
    public static boolean getMD5BlackString(String password, String dbpassword){
    ...
    public static void main(String arg[]) {
        ...
        String encryptedPwd = getMD5String(password);
        // 7E47F060B4F7D0E15E5643CCB5F3CC060BEBAC4A35A5A918D8D3176C
        System.out.println(encryptedPwd);

        // password：123456
        // encryptedPwd：7E47F060B4F7D0E15E5643CCB5F3CC060BEBAC4A35A5A918D8D3176C
        boolean checkPassword = getMD5BlackString(password, encryptedPwd);
        // true
